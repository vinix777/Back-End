    ...
    public class JogoController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Jogo != null ? 
                          ...
                          Problem("Entity set 'AppDbContext.Jogo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AppDbContext.Jogo'  is null.");
            }
            var jogo = await _context.Jogo.FindAsync(id);
            if (jogo != null)
            {
        ...
        {
          return (_context.Jogo?.Any(e => e.JogoId == id)).GetValueOrDefault();
        }
    }
}
